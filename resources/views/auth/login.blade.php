...
<body
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 dark:bg-gray-900 dark:shadow-black">
        <div class="flex flex-col items-center mb-6">
            <span class="text-3xl font-extrabold text-indigo-600 mb-2 tracking-wide dark:text-indigo-400">AyserNii Joki
            </span>
            <h2 class="text-2xl font-bold text-gray-800 mb-1 dark:text-gray-100">Welcome Back!</h2>
            <p class="text-gray-500 text-sm dark:text-gray-300">Please login to your account</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4 relative">
                ...
                <button type="button" onclick="togglePassword('password', this)" tabindex="-1"
                    class="absolute right-3 top-9 text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" id="icon-password" class="h-5 w-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-9-7s4-7 9-7c1.657 0 3.22.41 4.563 1.125" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19.07 4.93a9.953 9.953 0 012.93 5.07c0 3-4 7-9 7-.62 0-1.22-.06-1.8-.17" />
        ...
        <div class="mt-6 text-center">
            <span class="text-gray-600 text-sm dark:text-gray-300">Don't have an account?</span>
            <a href="{{ route('register') }}"
                class="text-indigo-600 hover:underline font-semibold text-sm dark:text-indigo-400">Register</a>
        </div>
    </div>
</body>
